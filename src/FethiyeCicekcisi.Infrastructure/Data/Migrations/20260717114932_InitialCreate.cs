        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContainsVase = table.Column<bool>(type: "boolean", nullable: false),
                    AllowsMessageCard = table.Column<bool>(type: "boolean", nullable: false),
                    IsSameDayDelivery = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PromoCode = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    ...
                    IsAnonymousSender = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    RecipientAddressLine1 = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
                    RecipientAddressLine2 = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    RecipientCity = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    RecipientDistrict = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    RecipientZipCode = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
                    DeliveryDate = table.Column<DateOnly>(type: "date", nullable: false),
                    DeliveryTimeSlot = table.Column<int>(type: "integer", nullable: false),
                    CardMessage = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceDifference = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayTRMerchantOid = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VariantInfo = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
