...
namespace FethiyeCicekcisi.Infrastructure.Data.Configurations;
...
public class DeliveryZoneConfiguration : IEntityTypeConfiguration<DeliveryZone>
{
    public void Configure(EntityTypeBuilder<DeliveryZone> builder)
    {
        ...
        builder.Property(z => z.Fee).HasPrecision(18, 2);
    }
}
...
public class OrderConfiguration : IEntityTypeConfiguration<Order>
{
    public void Configure(EntityTypeBuilder<Order> builder)
    {
        ...
        builder.Property(o => o.SenderName).IsRequired().HasMaxLength(200);
        builder.Property(o => o.SenderPhone).IsRequired().HasMaxLength(20);
        builder.Property(o => o.SenderEmail).IsRequired().HasMaxLength(200);
        builder.Property(o => o.RecipientFirstName).IsRequired().HasMaxLength(100);
        builder.Property(o => o.RecipientLastName).IsRequired().HasMaxLength(100);
        builder.Property(o => o.RecipientPhone).IsRequired().HasMaxLength(20);
        builder.Property(o => o.RecipientAddressLine1).IsRequired().HasMaxLength(300);
        builder.Property(o => o.RecipientAddressLine2).HasMaxLength(300);
        builder.Property(o => o.RecipientCity).IsRequired().HasMaxLength(100);
        builder.Property(o => o.RecipientDistrict).IsRequired().HasMaxLength(100);
        builder.Property(o => o.RecipientZipCode).HasMaxLength(10);
        builder.Property(o => o.CardMessage).HasMaxLength(200);
        builder.Property(o => o.TrackingNumber).HasMaxLength(100);
        builder.Property(o => o.GuestSessionId).HasMaxLength(100);
